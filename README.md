...
Photo blocks are now direct-editable on the canvas. Tap a photo, drag it to reposition, then drag the corner or edge handles to resize. Use the Edit panel for Fill/Fit, focus, radius, shadow, opacity, and exact width/height controls.
